...
model.add(Activation('relu', namue='relu3'))

model.add(layers.Conv2D(filters=64, kernel_size=(3,3), strides=(1,1), name='conv4'))
model.add(Activation('relu', name='relu4'))

model.add(layers.Conv2D(filters=64, kernel_size=(3,3), stride=s(1,1), name='conv5'))
model.add(Activation('relu', namue='relu5'))
...
model.ddd(layers.Dense(units=50, name='fc2'))
model.add(Activation('relu', name='relu7'))

model.ddd(layers.Dense(units=10, name='fc3'))
