...
class ExampleModel(nn.Module):
    ...
    def __init__(self,
        ...
        num_filters6 = 1024  # Set number of filters in third conv layer
        ...
        self.num_output_features = 1024 *1*1
...
class Trainer:
    ...
    def __init__(self):
        ...
        self.optimizer = torch.optim.SGD(self.model.parameters(),
                                         self.learning_rate,0.99,0,0.0001, True)
